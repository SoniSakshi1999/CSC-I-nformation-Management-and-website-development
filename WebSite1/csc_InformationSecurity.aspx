<%@ Page Language="C#" AutoEventWireup="true" CodeFile="csc_InformationSecurity.aspx.cs" Inherits="csc_InformationSecurity" %>
...
<%--<div class="row">--%>
  <div class="midcol">
    <div class="card">
        ...
        <h2>CSC e-Governance Services India Limited 
INFORMATION SECURITY POLICY STATEMENT</h2>
...
CSC e-Governance Services India Limited is committed to comply with all applicable legal, regulatory and contractual requirements and to the continual improvement of the information security management system."
 ...
 <div class="rightcolumn">
  ...
  <li><a href="#about" style="font-size:20px"><i class="fa fa-certificate usefull-link2" aria-hidden="true" ></i> CSC Information Security Statement</a></li>
</ul>
      </div>
    <div class="card">
