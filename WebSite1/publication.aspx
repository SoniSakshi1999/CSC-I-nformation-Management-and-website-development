...
<%--<div class="row">--%>
  <div class="midcol">
    <div class="card">
<a href="Default.aspx">Home</a> >> Resources >> Publication
<h2><b>CSC Annual Report</b><br></h2>
        
       <a href="Annual_Report_2015_16.pdf"><i style="font-size:24px" class="fa">&#xf073;</i>&nbsp;&nbsp;CSC Annual Report 2015 16</a><br>
      &nbsp;<br>
 <a href="Annual_Report_2014_15.pdf"><i style="font-size:24px" class="fa">&#xf073;</i>&nbsp;&nbsp;CSC Annual Report 2014 15</a><br>
 &nbsp;<br>
         <a href="Annual_Report_2013_14.pdf"><i style="font-size:24px" class="fa">&#xf073;</i>&nbsp;&nbsp;CSC Annual Report 2013 14</a><br>
      <br>
        &nbsp;<br>
        <h2><b>CSC SPV Info Presentation</b><br></h2>
        Common Services Centers (CSC) (Hindi: सर्व सेवा केंद्र) are multiple-services-single-point model for providing facilities for multiple transactions at a single geographical location.
        &nbsp;<br>

The PPP model of the CSC scheme envisages a 3-tier structure consisting of the CSC operator (called Village Level Entrepreneur or VLE);the Service Centre Agency (SCA), that will be responsible for covering a group of districts in a state; and a State Designated Agency (SDA) identified by the State Government responsible for managing the implementation over the entire State<br>

         <h2><b>THE VILLAGE LEVEL ENTREPRENEUR (VLE):</b><br></h2>
...
<br>
        ...
        <a href="CSC_SPV_Generic_PPT-Ver-8.pptx"><i style="font-size:24px" class="fa">&#xf073;</i>&nbsp;&nbsp;CSC SPV Generic PPT Version 8 click here for full PPT</a><br>
      <br>

        <h2><b>Digital India Empowering Women Booklet</b><br></h2>
        In the first ever celebration at a National level about the role of women in harnessing the opportunity provided by the Common Service Centers (CSC) under Government of India‟s Digital India Initiative, over 2000 CSC Village Level Entrepreneurs (VLEs) from across the country gathered for the National Conference of CSC Women Village Level Entrepreneurs (VLEs) held in the national capital on 20th February 2016.<br>
        &nbsp;<br>
        <a href="Event_Report_women_vle_final.pdf"><i style="font-size:24px" class="fa">&#xf073;</i>&nbsp;&nbsp;Digital India Empowering Womwn Booklet</a><br>
      <br>
