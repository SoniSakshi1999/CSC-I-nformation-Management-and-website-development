...
<%--<div class="row">--%>
  <div class="midcol">
    <div class="card">
<a href="Default.aspx">Home</a> >> About CSC >> CSC 2.0 Scheme
      <h2><b>CSC 2.0 Scheme</b><br></h2>
Based on the assessment of CSC scheme, the Government launched the CSC 2.0 scheme in 2015 to expand the outreach of CSCs to all Gram Panchayats across the country.<br>
        Under CSC 2.0 scheme, at least one CSC will be set up in each of the 2.5 lakh GPs across the country by 2019. CSCs functioning under the existing scheme will also be strengthened and integrated with additional 1.5 lakh CSCs across the country.<br>
        CSC 2.0 scheme would consolidate service delivery through a universal technology platform, thereby making e-services, particularly G2C services accessible to citizens anywhere in the country.<br>
     <h2><b>Key Features of CSC 2.0 scheme</b></h2><br>
       
        > A self-sustaining network of 2.5 lakh CSCs in Gram Panchayats<br>

> Large bouquet of e-services through a single delivery platform<br>
> Standardization of services and capacity building of stakeholders<br>
> Localised Help Desk support<br>
> Sustainability of VLEs through maximum commission sharing<br>
> Encouraging more women as VLEs<br>
