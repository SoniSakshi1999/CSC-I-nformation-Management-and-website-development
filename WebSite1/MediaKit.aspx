<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MediaKit.aspx.cs" Inherits="MediaKit" %>
...
<%--<div class="row">--%>
  <div class="midcol">
    <div class="card">
<a href="Default.aspx">Home</a> >> Media >> Media Kit
        <h2><b>Media Kit
</b><br></h2>
    
        <button class="accordion">Auto Rickshaw Drivers On Bhim App</button>
<div class="panel">
 <%-- <p>
      <video src="Auto-rickshaw%20drivers%20from%20Hazrat%20Nizamuddin%20railway%20station%20speaking%20on%20the%20benefits%20of%20BHIM%20app.%20D.mp4" controls="controls" />
  </p>--%>
    <video width="100%" height="350" controls>
  <source src="Auto-rickshaw%20drivers%20from%20Hazrat%20Nizamuddin%20railway%20station%20speaking%20on%20the%20benefits%20of%20BHIM%20app.%20D.mp4" controls="controls" type="video/mp4">
  
</video>
</div>
         <button class="accordion">CSC Film</button>
<div class="panel">

    <video width="100%" height="350" controls>
  <source src="CSC FILM - BHARAT KO BADALNE WALE.mp4" controls="controls" type="video/mp4">
  
</video>
</div>
        <button class="accordion">My Account User Guide</button>
<div class="panel">
    <a href="My%20account%20user%20guide.pdf" target="_blank">My account user guide.pdf</a>
</div>
              </div>
      <script>
