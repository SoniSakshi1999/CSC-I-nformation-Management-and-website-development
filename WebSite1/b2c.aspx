...
<%--<div class="row">--%>
  <div class="midcol">
    <div class="card">
<a href="Default.aspx">Home</a> >> Services >> Bussiness to Citizen
...
<%--      <div class="fakeimg" style="height:200px;">Image</div>--%>
     <h2><b>Business to Citizen</b><br></h2>
        
        <h3><b>Mobile Recharge</b><br></h3>
        Mobile Recharge of all the 14 Telecom Service Providers can be done through the Digital Seva Portal. This service connects with the Telecom Service Providers to enable customers recharge their mobile real time. The payments can be made through the e-wallet available through the Digital Seva Portal.<br>

        <h3><b>Mobile Bill payments</b></h3><br>
        Mobile Bill payments of 8 Telecom Service Providers can be done through the Digital Seva Portal. This service connects with the Telecom Service Providers to enable customers to pay their mobile bills real time.<br>

        <h3><b>DTH Recharge</b><br></h3>
        Dish TV Recharge of all six DTH operators can be done through the Digital Seva Portal.<br>
