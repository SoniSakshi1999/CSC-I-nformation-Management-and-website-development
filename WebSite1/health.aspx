...
<%--<div class="row">--%>
  <div class="midcol">
    <div class="card">
<a href="Default.aspx">Home</a> >> Services >> Health Services
...
<script>
    ...
    function carousel() {
        ...
        <h2><b>Health Services</b><br></h2>
        
        <h3><b>Tele-health Consultations:</b><br></h3>
       Derived from Greek word "Tele" meaning "distance" and Latin word "mederi" meaning "to heal”, telemedicine is the form of primary care where the patient seeks the doctor’s advice about non-emergency medical problems which don’t require doctor’s location visit. It doesn’t replace face-to-face consultation when it is needed, but complements it. In order to provide grass root level access points for health consultation among communities through digital medium, CSC is offering video based tele-consultation service throughout India at affordable rates. CSC SPV partnered with Apollo Hospitals Limited in 2014 to allow the VLEs across the country to facilitate the tele-consultations with doctors from Apollo Hospitals. In 2016, CSC SPV launched its own tele-health consultation services throughout India through Allopathic, Homeopathic and Ayurvedic doctors across the country.<br>
       <h3><b>Pradhan Mantri Jan Aushadhi Scheme:</b><br></h3>
        Pradhan Mantri Jan Aushadhi Scheme aims at making quality medicines available at affordable prices for all, particularly the poor and disadvantaged, through exclusive outlets called ‘Jan Aushadhi Medical Stores’. The scheme is implemented by the Bureau of Pharmaceutical Public Sector Undertaking (BPPI). CSC SPV partnered with BPPI in 2015 to set up generic medicine stores under the Jan Aushadhi Scheme at the CSCs across the country.<br>
        <h3><b>Diagnostic Services:</b><br></h3>
       <b> Hello Health Kits:</b>&nbsp; Launched in September 2016 in collaboration with Hello Health, diagnostic kits are used to test parameters like Blood glucose, BP, ECG, BMI, Spyrometry, Pulse oximetry and Body Temperature. Hello Health kits have been piloted in West Bengal, Tamil Nadu, Punjab & Haryana.<br>
        &nbsp;<br>
        <b>3Nethra Kits:</b><br> CSC SPV has partnered with Forus Health Private Ltd (3 Nethra) for eye testing services at CSCs. The service was launched in November 2016.<br>
        &nbsp;<br>
        <b>Tele-medicine Remote Diagnostic Kit – Control H:</b> Control-H is an integrated wireless healthcare monitoring medical device that helps in monitoring Blood Pressure, Heart Rate, Blood Oxygen, body temperature, Total Cholesterol, Haemoglobin, and Blood Glucose.<br>
        &nbsp;<br>
        <b>Thyrocare:</b> CSC SPV has partnered with Thyrocare to provide diagnostic services through CSCs. Thyrocare diagnostic services have been piloted in Aurangabad, Maharashtra and VLEs can offer following diagnostic tests at affordable prices:<br>


• Blood Test - CBC, HBA1c & TSH<br>
• Urine Test - Urinary MA, Creatinine and Albumin/Creatinine Ratio<br>
• Water Test - Detection of physical & chemical impurities, elements, bacteria & pesticides in water<br>
        <b>JIVA Ayurveda Scheme:</b> CSC SPV has partnered with JIVA Ayurveda to bring Ayurveda consultation and over 150 Ayurvedic products to citizens through the CSC network. The service was launched in July 2016 in Haryana, Uttar Pradesh and Punjab. JIVA Ayurveda product sale is now live in Madhya Pradesh, Maharashtra, West Bengal, apart from northern Indian states.<br>

        <b>Health Homeo :</b> CSC SPV has launched a new service called Health Homeo package, which contains the following:<br>



- 9 doctor consultations via video call.<br>
- Treatment for unlimited diseases and health problems throughout the year and unlimited German medicines for the patient for one year.<br>
- No courier charges for up to six couriers of medicines; after six deliveries.<br>
- Free Homoeopathic Family First Aid kit.<br>
- Treatment provided by World’s largest Homoeopathy treatment portal, ‘welcomecure.com’.<br>
