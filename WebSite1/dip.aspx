...
<%--<div class="row">--%>
  <div class="midcol">
    <div class="card">
<a href="Default.aspx">Home</a> >> Services >> Digitize India Platform
...
<script>
    ...
    function carousel() {
        ...
        setTimeout(carousel, 2000); // Change image every 2 seconds
         ...
         <h2><b>Digitize India Platform</b><br></h2>
        
        <h3><b>Your Chance to Build India - DIGITIZE INDIA PLATFORM (DIP)</b><br></h3>
       A Digital India Initiative Implemented by CSC e-Governance Services India Pvt Ltd. Participate in Digitize India Initiative & Get Paid<br>
       <h3><b>Background</b><br></h3>
        DIP is an initiative of Government of India under Digital India program to digitize physical records and reduce piles of papers stored in record rooms or offices of Government, Government organizations and even non-Governmental private organizations. It allows organizations not only to free their warehousing real estate but enables them to keep their records longer and in safer environment.<br>
        <h3><b>How to join the Digitize India Platform</b><br></h3>
       It's a simple three step process to start earning rewards:
        <br>
<b>Step 1 -</b> Visit digitizeindia.gov.in and registers as a user. This is as simple as creating an email account.<br>

<b>Step 2 - </b>Log in with your user id/password and start digitizing.<br>

<b>Step 3 - </b>Digitize India Platform will facilitate in checking the accuracy, calculating the rewards and make payment to the user/participant .<br>



        <h3><b>How to submit records for digitization to DIP</b><br></h3>
        Any organization (Government Department/Government organization/private organization) can submit their records for digitization to CSC SPV. The records should preferably be in a scanned image format. However, organizations who wish to submit physical records will have to pay for scanning separately.<br>
       &nbsp; <br>

The CSC SPV helps creating template of pages being digitized and submits the template for approval of organization submitting the records for organization. The data/records are thereafter processed for digitization.<br>
