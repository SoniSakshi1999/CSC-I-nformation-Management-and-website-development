...
<%--<div class="row">--%>
  <div class="midcol">
    <div class="card">
<a href="Default.aspx">Home</a> >> Resources >> CSC 2.0 Implementation Guidelines
<h2><b>CSC 2.0 Implementation Guidelines</b><br></h2>
        
       <a href="images/Annual_Report_2015_16.pdf"><i style="font-size:24px" class="fa">&#xf073;</i>&nbsp;&nbsp;CSC Annual Report 2015 16</a><br>
      &nbsp;<br>
 <a href="images/Annual_Report_2014_15.pdf"><i style="font-size:24px" class="fa">&#xf073;</i>&nbsp;&nbsp;CSC Annual Report 2014 15</a><br>
 &nbsp;<br>
         <a href="images/Annual_Report_2013_14.pdf"><i style="font-size:24px" class="fa">&#xf073;</i>&nbsp;&nbsp;CSC Annual Report 2013 14</a><br>
      <br>
        &nbsp;<br>
        <h2><b>CSC SPV Info Presentation</b><br></h2>
        Guidelines for implementation of “Common Services Centre 2.0 – A way forward” under Digital India Programme<br>
        &nbsp;<br>

   <h3><b>Abstract:</b><br></h3>
        This document is intended for State Governments/UT Administrations and District Administrations as guidance for executing the CSC 2.0-A way Forward in the States/UTs. The document describes CSC 2.0 along with its objectives, governance mechanism, role and responsibilities of the stakeholders.
<br>
        &nbsp;<br>
<h3><b>CSC 2.0- A Way Forward:</b><br></h3>
        CSC 2.0, approved in August 2015, aims to establish self sustaining network of 2.5 lakhs CSC centres at Gram Panchayat (GP) level under Digital India- Pillar 3-Public Internet Access Programme – National Rural Internet Mission and deliver various citizen centric services. The model of CSC 2.0 is envisaged as transaction based and service delivery based model, delivering a large bouquet of e-services through a single delivery technological platform, which would increase the sustainability of the CSCs across the country.<br>

       
        <a href="Note_on_CSC_Scheme_Revised.docx"><i style="font-size:24px" class="fa">&#xf073;</i>&nbsp;&nbsp;CSC 2.0 Implementation Guidelines(Click Here For Complete Guidelines)</a><br>
      <br>
