...
<h2><b>CSC Sitemap</b><br></h2>
<ol>
 <h4><li>HOME</li></h4>
 <h4><li>ABOUT CSC</li></h4>
    <ul>
 <li>About MeitY</li>
 <li>About Digital India</li>
 <li>CSC 2.0 Scheme</li>
 <li>About CSC e-Governance Services India Ltd</li>
</ul>
    
 <h4><li>SERVICES</li></h4>
    <ul>
 <li>Government to Citizen</li>
 <li>Business to Citizen</li>
 <li>Financial Inclusion</li>
 <li>Education</li>
 <li>Agriculture</li>
 <li>Health Services</li>
 <li>Digitize India Platform</li>
 <li>DigiPay</li>
    </ul>
 ...
 <ul>
    <li>Publications</li>
<li>CSC Annual Report</li> 
 <li>CSC 2.0 Implementation Guidelines</li>
 <li>Common Branding CSC 2.0</li>
...
<ul>
 <li>CSC Events</li>
 <li>CSC Monthly e-Magazine Tarang</li>
 <li>Newsletters</li>
