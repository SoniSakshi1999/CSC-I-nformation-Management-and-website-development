...
<%--<div class="row">--%>
  <div class="midcol">
    <div class="card">
<a href="Default.aspx">Home</a> >> Resources >> Right To Information
 <h2><b>Right to Information</b><br></h2>
        
     
 Right to Information Act 2005 mandates timely response to citizen requests for government information. It is an initiative taken by Department of Personnel and Training, Ministry of Personnel, Public Grievances and Pensions to provide a– RTI Portal Gateway to the citizens for quick search of information on the details of first Appellate Authorities,PIOs etc. amongst others, besides access to RTI related information / disclosures published on the web by various Public Authorities under the government of India as well as the State Governments.<br>
               <a href="rti_act.pdf"><i style="font-size:24px" class="fa">&#xf019;</i>&nbsp;&nbsp;Download Right to Information</a><br>
      &nbsp;<br>
